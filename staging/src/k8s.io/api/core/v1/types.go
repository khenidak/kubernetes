...
type ServiceSpec struct {
	...
	// values provided in service.spec.ipFamilies. service.spec.clusterIPs[0]
	// is expected to match service.spec.clusterIP. If they don't match then
	// service.spec.clusterIP value will be used.
	// +listType=atomic
	// +optional
