...
func (r *GenericREST) defaultServiceOnRead(obj runtime.Object) error {
	...
	if ok {
		return r.defaultSvcOnRead(service)
	}
...
func (r *GenericREST) defaultSvcOnRead(service *api.Service) error {
	if service == nil {
		return nil
	}
	...
	if len(service.Spec.ClusterIPs) == 1 && service.Spec.ClusterIPs[0] == api.ClusterIPNone {
		...
		if len(service.Spec.Selector) == 0 {
			...
			if r.secondaryFamily != nil { // dualstack cluster
